...
#endif
*/
  pinMode(53, OUTPUT); // PSF: skip the above because Mega is known
  Serial.begin(9600);
  ...
  */
  ...
  //cam.reset(); // TODO Psf need to reset cam after setting image size?
